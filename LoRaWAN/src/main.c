...
int main(void)
{
  ...
  while(1)
  {
	  ...
	  //ham doc gia tri: temperature =...
	  PRINTF("GIA TRI NHIET DO:%02d\r\n", temperature);
	  DelayMs(200);

	  /* -- Doc va hien thi gia tri DO AM --*/
	  //ham doc gia tri: humidity =...
	  PRINTF("GIA TRI DO AM:%02d\r\n", humidity);
	  DelayMs(200);

	  /* -- Doc va hien thi gia tri AP SUAT--*/
	  //ham doc gia tri: pressure =...
	  PRINTF("GIA TRI AP SUAT:%02d\r\n", pressure);
	  DelayMs(200);
  }
